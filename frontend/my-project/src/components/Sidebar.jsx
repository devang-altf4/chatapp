    ...
    <div className="sidebar">
      ...
      <div className="sidebar-brand">
        ...
        <div className="sidebar-brand-text">
          <div className="sidebar-brand-name">ChatFlow</div>
          <div className="sidebar-brand-version">v2.4</div>
        </div>
      </div>
      ...
      <nav className="sidebar-nav">
        <button
          className={`sidebar-nav-item ${activeView === 'chats' ? 'active' : ''}`}
          onClick={() => setActiveView('chats')}
          type="button"
        >
          <span className="sidebar-nav-icon">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M21 11.5C21 16.1944 16.9706 20 12 20C10.4607 20 9.01172 19.6565 7.74467 19.0511L3 20L4.39499 16.28C3.51156 15.0423 3 13.5743 3 11.5C3 6.80558 7.02944 3 12 3C16.9706 3 21 6.80558 21 11.5Z" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </span>
      ...
      <div className="sidebar-footer">
        <div className="sidebar-user">
          ...
          <button onClick={logout} className="sidebar-logout" title="Logout" type="button">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
